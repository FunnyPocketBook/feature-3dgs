...
# python train.py -s /workspace/data/tree18/colmap -m /workspace/output/tree18_sam/ -f sam -r 4 --speedup --save_iterations 100 200 300 400 500 600 700 800 900 1000 2000 5000 7000 10000 15000 20000 --checkpoint_iterations 100 200 300 400 500 600 700 800 900 1000 2000 5000 7000 10000 15000 20000 --eval --iterations 20000
